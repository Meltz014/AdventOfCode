...
def main():
    ...
    patterns = {}
    for i in range(reps):
        real_signal = numpy.array([phase_digit(real_signal, i+1) for i in range(len(real_signal))], dtype=numpy.int8)

    print('Part 2:' + ''.join(str(i) for i in real_signal[offset:offset+8]))
